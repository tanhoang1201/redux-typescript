...
import { delPost, startEditPost } from '../../blog.slice';
			...
			<div className='flex flex-col gap-2 p-4 lg:p-6'>
				...
				<div>
					<div className='inline-flex rounded-md shadow-sm' role='group'>
						...
						<button
							type='button'
							className='rounded-r-lg border-t border-b border-r border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 focus:ring-2 focus:ring-blue-700'
